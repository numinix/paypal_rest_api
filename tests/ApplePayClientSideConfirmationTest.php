...
class ApplePayClientSideConfirmationTest
{
    ...
    public function __construct()
    {
        ...
        $this->jsFile = dirname(__DIR__) . '/zc_plugins/PayPalAdvancedCheckout/v2.0.0/catalog/includes/modules/payment/paypal/PayPalAdvancedCheckout/jquery.paypalac.applepay.js';
