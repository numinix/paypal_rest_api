 ...
 * based on MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS configuration.
 * 
...
if (!defined('MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS')) {
    define('MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS', 'visa,mastercard,amex,discover');
}
...
if (!defined('MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS')) {
    $testPassed = false;
    $errors[] = "MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS constant not defined";
} else {
    echo "✓ MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS constant is defined\n";
}
