...
$helpers = file_get_contents($root . '/zc_plugins/PayPalAdvancedCheckout/v2.0.0/catalog/includes/functions/extra_functions/paypalac_subscription_functions.php');
...
$module = file_get_contents($root . '/zc_plugins/PayPalAdvancedCheckout/v2.0.0/catalog/includes/modules/payment/paypalac.php');
assert_true(strpos($module, "CURRENT_VERSION = '1.3.19'") !== false, 'CURRENT_VERSION is 1.3.19');

echo "\nTest 6: Runtime compute math...\n";
require_once $root . '/zc_plugins/PayPalAdvancedCheckout/v2.0.0/catalog/includes/functions/extra_functions/paypalac_subscription_functions.php';
