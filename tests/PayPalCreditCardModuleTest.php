...
/**
 * Test that validates the paypalr_creditcard module can be instantiated
...
namespace PayPalCreditCardModuleTest {
    ...
    class PayPalCreditCardModuleInstantiationTest extends TestCase
    {
        public function testModuleCanBeInstantiated(): void
        {
            ...
            $this->assertInstanceOf(\paypalr_creditcard::class, $module);
            $this->assertEquals('paypalr_creditcard', $module->code);
        }
        ...
        public function testModuleExtendsPayPalr(): void
        {
            ...
            $this->assertInstanceOf(\paypalr::class, $module);
        }
        ...
        public function testModuleConfigurationKeys(): void
        {
            ...
            $this->assertContains('MODULE_PAYMENT_PAYPALR_CREDITCARD_STATUS', $keys);
