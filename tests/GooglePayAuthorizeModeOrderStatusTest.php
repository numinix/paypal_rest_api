 ...
 * - Google Pay is a wallet payment (not a card payment)
 *
 * Problem Statement:
...
class GooglePayAuthorizeModeOrderStatusTest
{
    ...
    {
        $this->applePayFile = dirname(__DIR__) . '/zc_plugins/PayPalAdvancedCheckout/v2.0.0/catalog/includes/modules/payment/paypalac_googlepay.php';
...
// Run the test
try {
    $test = new GooglePayAuthorizeModeOrderStatusTest();
    $test->run();
} catch (Exception $e) {
