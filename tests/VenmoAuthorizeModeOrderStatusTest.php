...
class VenmoAuthorizeModeOrderStatusTest
{
    ...
    {
        $this->applePayFile = dirname(__DIR__) . '/includes/modules/payment/paypalr_venmo.php';
    ...
    private function testConstructorLogicMatchesPaypalr(): void
    {
        ...
        if ($applePayHasFinalSale && $applePayHasCardOnly && $applePayHasOrderStatus && $applePayHasPendingStatus &&
            ...
            $this->testResults[] = [
                ...
                'passed' => true,
                'message' => 'Venmo constructor uses same transaction mode logic as main paypalr module'
            ];
            ...
            $this->testResults[] = [
                'name' => 'Constructor logic matches paypalr',
                'passed' => false,
                'message' => 'Logic differs between Venmo and main paypalr module'
            ];
