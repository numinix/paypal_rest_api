                ...
                <div class="nmx-form">
                  ...
                  <?php echo zen_draw_form('hideregistration_register', zen_href_link(FILENAME_ONE_PAGE_CHECKOUT, 'type=register&hideregistration=true&step=2', 'SSL'), 'post', 'id="hideregistration_register"'); ?>
                    ...
                    <div class="nmx-form-group">
                      ...
                      <?php echo zen_draw_input_field('hide_email_address_register', (isset($_SESSION['email_address_register']) ? $_SESSION['email_address_register'] : ''), zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' class="nmx-form-control"'); ?>
                    </div>
                    <!-- end email -->
                    ...
                    <?php if (OPRC_CONFIRM_EMAIL == 'true') { ?>
                      <div class="nmx-form-group">
                        ...
                        <?php echo zen_draw_input_field('hide_email_address_confirm', (isset($_SESSION['email_address_confirm']) ? $_SESSION['email_address_confirm'] : ''), zen_set_field_length(TABLE_CUSTOMERS, 'customers_email_address', '40') . ' class="nmx-form-control"'); ?>
                      </div>
                    <?php } ?>
                    <!-- end confirm email -->
...
?>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var hideRegistration = document.getElementById('hideRegistration');
    if (hideRegistration) {
      hideRegistration.style.display = 'none';
    }
  });
  //--></script>
<?php 
