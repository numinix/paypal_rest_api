<?php
  ...
  if (OPRC_HIDE_REGISTRATION == 'true') {
    $order_steps = array(
      1 => HEADING_STEP_1,
      2 => ((OPRC_SHIPPING_ADDRESS == 'false' || $_SESSION['cart']->get_content_type() == 'virtual') ? HEADING_STEP_2_NO_SHIPPING : HEADING_STEP_2),
      3 => ((OPRC_SHIPPING_ADDRESS == 'false' || $_SESSION['cart']->get_content_type() == 'virtual') ? HEADING_STEP_3_NO_SHIPPING : HEADING_STEP_3)
    );
  } else {
    $order_steps = array(
      1 => ((OPRC_SHIPPING_ADDRESS == 'false' || $_SESSION['cart']->get_content_type() == 'virtual') ? HEADING_STEP_2_NO_SHIPPING : HEADING_STEP_2),
      2 => ((OPRC_SHIPPING_ADDRESS == 'false' || $_SESSION['cart']->get_content_type() == 'virtual') ? HEADING_STEP_3_NO_SHIPPING : HEADING_STEP_3)
    );
  }
