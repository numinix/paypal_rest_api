        ...
        <div class="nmx-buttons">
          ...
          <span class="nmx-button-helper"><?php echo TITLE_CONTINUE_CHECKOUT_PROCEDURE . '<br>' . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></span>
				...
				<?php
				  if ($process == true) {
				?>
				  <div class="buttonRow back"><?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '">' . (OPRC_CSS_BUTTONS == 'true' ? zenCssButton(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT, 'button', 'button_back') : zen_image_button(BUTTON_IMAGE_BACK, BUTTON_BACK_ALT)) . '</a>'; ?></div>
