...
$outputBraintree .= '<a href="https://' . (MODULE_PAYMENT_BRAINTREE_SERVER == "sandbox" ? "sandbox" : "www") . '.braintreegateway.com/merchants/' . MODULE_PAYMENT_BRAINTREE_MERCHANTID . '/transactions/' . $txnId . '" target="_blank">' . $txnId . '</a>' ."\n";
$outputBraintree .= '</td></tr>'."\n";
...
if (method_exists($this, '_doRefund')) {
    try {
        ...
        // Already handled/logged elsewhere
    }
}
