...
require_once dirname(__DIR__, 4) . '/catalog/includes/modules/payment/paypal/ppacAutoload.php';
if (!trait_exists('Zencart\\Traits\\ObserverManager')) {
    require_once dirname(__DIR__, 4) . '/catalog/includes/modules/payment/paypal/PayPalAdvancedCheckout/Compatibility/ObserverManager.php';
}
...
class zcObserverPaypalacAdmin
{
    ...
    {
        // -----
        // If the paypalac payment-module isn't installed or isn't configured to be enabled,
    ...
    public function updateZenUpdateOrdersHistoryAfterInsert(&$class, $eventID, int $osh_id, array $data): void
    {
        ...
        require_once dirname(__DIR__, 4) . '/catalog/includes/modules/payment/paypalac.php';
