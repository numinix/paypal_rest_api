...
if (!defined('TEXT_PAYPALAC_SUBSCRIPTION_ORDER_LOG')) {
    define('TEXT_PAYPALAC_SUBSCRIPTION_ORDER_LOG', 'Order Log');
}
if (!defined('TEXT_PAYPALAC_SUBSCRIPTION_ORDER_LOG_EMPTY')) {
    define('TEXT_PAYPALAC_SUBSCRIPTION_ORDER_LOG_EMPTY', 'No orders logged yet.');
}
if (!defined('TEXT_PAYPALAC_SUBSCRIPTION_EXPIRY_DATE')) {
    define('TEXT_PAYPALAC_SUBSCRIPTION_EXPIRY_DATE', 'Expiry Date');
}
if (!defined('TEXT_PAYPALAC_SUBSCRIPTION_EXPIRY_INDEFINITE')) {
    define('TEXT_PAYPALAC_SUBSCRIPTION_EXPIRY_INDEFINITE', 'Indefinite');
}
