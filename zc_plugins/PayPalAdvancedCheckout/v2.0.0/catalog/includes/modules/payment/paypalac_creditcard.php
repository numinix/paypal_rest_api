...
$paypalacSubscriptionHelper = dirname(__DIR__, 2) . '/functions/extra_functions/paypalac_subscription_functions.php';
        ...
        if (defined('MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS') && strlen(MODULE_PAYMENT_PAYPALAC_CREDITCARD_ACCEPTED_CARDS) > 0) {
            ...
            foreach ($accepted_types as $type) {
                ...
                if (isset($cardImageMap[$type])) {
                    $imagePath = \PayPalAdvancedCheckout\Common\PluginPaths::publicImageUrl($cardImageMap[$type]);
