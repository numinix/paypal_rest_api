...
// InitSystem loads this file from method scope; only $GLOBALS['loaderPrefix'] is visible here.
 ...
 */
$webhookCompatDir = dirname(__DIR__) . '/modules/payment/paypal/PayPalAdvancedCheckout/Compatibility/';
