...
require_once dirname(__DIR__, 2) . '/modules/payment/paypal/ppacAutoload.php';
if (!trait_exists('Zencart\\Traits\\ObserverManager')) {
    require_once dirname(__DIR__, 2) . '/modules/payment/paypal/PayPalAdvancedCheckout/Compatibility/ObserverManager.php';
}
...
<?= file_get_contents(dirname(__DIR__, 2) . '/modules/payment/paypal/PayPalAdvancedCheckout/jquery.paypalac.jssdk_messages.js'); ?>
</script>
<?php
        return;
    }
