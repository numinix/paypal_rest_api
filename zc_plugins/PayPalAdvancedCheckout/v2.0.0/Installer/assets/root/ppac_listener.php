...
$autoloaderPath = ppac_find_catalog_includes_file('modules/payment/paypal/PayPalAdvancedCheckout/Compatibility/LanguageAutoloader.php');
if ($autoloaderPath !== null && is_file($autoloaderPath)) {
...
//
if (!defined('MODULE_PAYMENT_PAYPALAC_STATUS') || MODULE_PAYMENT_PAYPALAC_STATUS === 'False') {
