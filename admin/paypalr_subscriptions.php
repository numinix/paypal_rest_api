...
<head>
    ...
    <link rel="stylesheet" href="includes/css/paypalr_subscriptions.css">
</head>
<body>
...
<script>
var paypalrSubscriptionsBaseUrl = <?php echo json_encode(zen_href_link(FILENAME_PAYPALR_SUBSCRIPTIONS, '')); ?>;
</script>
<script src="includes/javascript/paypalr_subscriptions.js"></script>
