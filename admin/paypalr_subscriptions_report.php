...
define('FILENAME_PAYPALR_SUBSCRIPTIONS_REPORT', basename(__FILE__));
...
function asr_build_sort_link($field, $currentSort, $currentDir)
{
    ...
    return zen_href_link(FILENAME_PAYPALR_SUBSCRIPTIONS_REPORT, $params . 'sort=' . $field . '&dir=' . $direction);
}
