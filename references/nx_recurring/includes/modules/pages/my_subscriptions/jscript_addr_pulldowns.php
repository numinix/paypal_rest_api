...
<?php echo zen_js_zone_list('SelectedCountry', 'theForm', 'zone_id'); ?>
  ...
  function update_zone_shipping(theForm) {
    ...
    // build dynamic list of countries/zones for pulldown
  <?php echo zen_oprc_js_zone_list_shipping('SelectedCountry', 'theForm', 'zone_id_shipping'); ?>
  ...
  function hideStateField(theForm) {
    ...
    document.getElementById("state").className = 'hiddenField';

    jQuery("#zoneLabel").prev(".disablejAlert").show();
    jQuery("#stateLabel").prev(".disablejAlert").hide();
    

    document.getElementById("state").setAttribute('className', 'hiddenField');    
    document.getElementById("stBreak").className = 'hiddenField';
    document.getElementById("stBreak").setAttribute('className', 'hiddenField');
    document.getElementById("stateZone").setAttribute('className', 'no-class');
  }
  ...
  function showStateField(theForm) {
    ...
    document.getElementById("state").className = 'visibleField';
    document.getElementById("state").setAttribute('className', 'visibleField');    
    ...
    jQuery("#zoneLabel").prev(".disablejAlert").hide();
    jQuery("#stateLabel").prev(".disablejAlert").show();

    document.getElementById("stateZone").setAttribute('className', 'no-validate');
  }
