...
class PayPal
{
     ...
     * @return	array
     */
    public function GetPalDetails($DataArray)
    {
    ...
    public function CreateRecurringPaymentsProfile($DataArray)
    {
        ...
        $CCDetails = isset($DataArray['CCDetails']) ? $DataArray['CCDetails'] : array();
        foreach ($CCDetails as $CCDetailsVar => $CCDetailsVal) {
            $CRPPFieldsNVP .= $CCDetails != '' ? '&' . strtoupper($CCDetailsVar) . '=' . urlencode((string)$CCDetailsVal) : '';
        }
...
class PayPal_Adaptive extends PayPal
{
     ...
     */
    public function BuildHeaders($PrintHeaders)
    {
        $headers = array(
     ...
     * @return	string
     */
    public function CURLRequest($Request, $APIName = null, $APIOperation = null)
    {
        $curl = curl_init();
        curl_setopt($curl, CURLOPT_VERBOSE, 1);
        curl_setopt($curl, CURLOPT_SSL_VERIFYPEER, false);
     ...
     * @return	array
     */
    public function PaymentDetails($DataArray)
    {
     ...
     * @return	array
     */
    public function ExecutePayment($DataArray)
    {
     ...
     * @return	array
     */
    public function SetPaymentOptions($DataArray)
    {
     ...
     * @return	array
     */
    public function Preapproval($DataArray)
    {
     ...
     * @return	array
     */
    public function PreapprovalDetails($DataArray)
    {
     ...
     * @return	array
     */
    public function CancelPreapproval($DataArray)
    {
     ...
     * @return	array
     */
    public function ConvertCurrency($DataArray)
    {
     ...
     * @return	array
     */
    public function CreateAccount($DataArray)
    {
