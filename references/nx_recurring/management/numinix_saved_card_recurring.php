...
while (!$result->EOF) {
    $customers[$result->fields['customers_id']] = $result->fields['customers_lastname'] . ', ' . $result->fields['customers_firstname'] . ' (' . ($result->fields['customers_project'] != '' ? $result->fields['customers_project'] : 'NC') . ')';
