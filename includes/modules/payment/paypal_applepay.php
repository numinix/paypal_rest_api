<?php
/**
 * paypal_applepay.php payment module class for handling Apple Pay via PayPal Advanced Checkout.
 *
...
class paypal_applepay extends paypalr
{
    /**
    ...
    public function selection(): array
    {
        ...
        $hiddenFields =
            ...
            zen_draw_hidden_field('paypal_applepay_payload', '', 'id="paypal-applepay-payload"') .
            zen_draw_hidden_field('paypal_applepay_status', '', 'id="paypal-applepay-status"');

        $script = '<script>' . file_get_contents(DIR_WS_MODULES . 'payment/paypal/PayPalRestful/jquery.paypal.applepay.js') . '</script>';
    ...
    public function pre_confirmation_check()
    {
        ...
        $payloadRaw = $_POST['paypal_applepay_payload'] ?? '';
        if (trim($payloadRaw) === '') {
