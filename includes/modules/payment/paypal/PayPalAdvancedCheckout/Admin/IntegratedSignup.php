...
class IntegratedSignup
{
    ...
    private ?PayPalAdvancedCheckoutApi $api = null;
    ...
    private function initializeApi(): void
    {
        ...
        $this->api = new PayPalAdvancedCheckoutApi($this->environment, $clientId, $clientSecret);
    }
    ...
    private function buildPayload(): array
    {
        ...
        $thirdPartyDetails = [
            ...
            'partner_attribution_id' => PayPalAdvancedCheckoutApi::PARTNER_ATTRIBUTION_ID,
        ];
