<?php
/**
 * A token-caching class for the PayPalAdvancedCheckout (paypalac) Payment Module
 *
...
class TokenCache
{
    ...
    {
        $token_environment = $_SESSION['PayPalAdvancedCheckout']['TokenCache']['environment'] ?? '';
        ...
        $seconds_to_expiration = ($_SESSION['PayPalAdvancedCheckout']['TokenCache']['token_expires_ts'] ?? 0) - time();
        ...
        $encrypted_token = $_SESSION['PayPalAdvancedCheckout']['TokenCache']['saved_token'];
    ...
    public function save(string $access_token, int $seconds_to_expiration)
    {
        ...
        $_SESSION['PayPalAdvancedCheckout']['TokenCache'] = [
    ...
    public function clear()
    {
        ...
        unset($_SESSION['PayPalAdvancedCheckout']['TokenCache']);
    }
}
