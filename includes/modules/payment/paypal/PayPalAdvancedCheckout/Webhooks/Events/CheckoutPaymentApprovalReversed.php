...
class CheckoutPaymentApprovalReversed extends WebhookHandlerContract
{
    ...
    public function action(): void
    {
        ...
        $this->paymentModule->sendAlertEmail(MODULE_PAYMENT_PAYPALAC_ALERT_SUBJECT_ORDER_ATTN, sprintf(MODULE_PAYMENT_PAYPALAC_ALERT_EXTERNAL_TXNS, $oID));

        // Alert any listeners
        global $zco_notifier;
        $zco_notifier->notify('NOTIFY_PAYPALAC_ADMIN_FUNDS_IN_OUT', ['webhook' => $this->data]);
    }
}
