<?php
/**
 * paypal_googlepay.php payment module class for handling Google Pay via PayPal Advanced Checkout.
 *
...
class paypal_googlepay extends paypalr
{
    /**
    ...
    public function selection(): array
    {
        ...
        $buttonContainer = '<div id="paypal-googlepay-button" class="paypal-googlepay-button"></div>';
        $hiddenFields =
            zen_draw_hidden_field('ppr_type', 'google_pay') .
            zen_draw_hidden_field('paypal_googlepay_payload', '', 'id="paypal-googlepay-payload"') .
            zen_draw_hidden_field('paypal_googlepay_status', '', 'id="paypal-googlepay-status"');

        $script = '<script>' . file_get_contents(DIR_WS_MODULES . 'payment/paypal/PayPalRestful/jquery.paypal.googlepay.js') . '</script>';
    ...
    public function pre_confirmation_check()
    {
        ...
        $payloadRaw = $_POST['paypal_googlepay_payload'] ?? '';
        if (trim($payloadRaw) === '') {
