...
if (defined('MODULE_PAYMENT_PAYPALAC_VENMO_TEXT_TITLE')) {
    return;
}
...
$languageFiles = [];
if (!function_exists('paypalacVenmoGetTemplateOverrideDirectory')) {
    function paypalacVenmoGetTemplateOverrideDirectory()
    {
...
$templateDirectory = paypalacVenmoGetTemplateOverrideDirectory();
if ($templateDirectory !== null) {
    $languageFiles[] = $languageDirectory . $templateDirectory . '/lang.paypalac_venmo.php';
}
$languageFiles[] = $languageDirectory . 'lang.paypalac_venmo.php';
