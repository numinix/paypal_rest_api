...
if (IS_ADMIN_FLAG === true) {
    ...
    $define['MODULE_PAYMENT_PAYPALR_TEXT_ADMIN_UPGRADE_AVAILABLE'] = '<br><br><p><strong>Update Available:</strong> Version %2$s is available. You are currently running version %1$s.</p><p><a class="paypalr-upgrade-button" href="%3$s">Upgrade to %2$s</a></p>';
