...
$define = [
    ...
    'MODULE_PAYMENT_PAYPALR_ALERT_MSG_CONFIGURATION' => 'Configuration',

    'MODULE_PAYMENT_PAYPALR_TEXT_EC_HEADER' => 'Fast, Secure Checkout with PayPal:',
    ...
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_FIRSTNAME' => 'Credit Card First Name:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_LASTNAME' => 'Credit Card Last Name:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_OWNER' => 'Cardholder Name:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_TYPE' => 'Credit Card Type:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_NUMBER' => 'Credit Card Number:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_EXPIRES' => 'Credit Card Expiry Date:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_ISSUE' => 'Credit Card Issue Date:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_CVV' => 'CVV Number:',
    'MODULE_PAYMENT_PAYPALR_TEXT_CREDIT_CARD_CHECKNUMBER_LOCATION' => '(on back of the credit card)',

    'MODULE_PAYMENT_PAYPALR_TEXT_DECLINED' => 'Your credit card was declined. Please try another card or contact your bank for more information.',
    ...
    'MODULE_PAYMENT_PAYPALR_TEXT_EMAIL_ERROR_SUBJECT' => 'ALERT: PayPalCheckout Error',
    ...
    'MODULE_PAYMENT_PAYPALR_TEXT_ERROR' => 'An error occurred when we tried to process your credit card. Please try again, select an alternate payment method or contact the store owner for assistance.',
    ...
    'MODULE_PAYMENT_PAYPALR_TEXT_UNILATERAL' => ' - You need to register your PayPal API Credentials before you can do advanced transaction processing.',
    'MODULE_PAYMENT_PAYPALR_TEXT_STATE_ERROR' => 'The state assigned to your account is not valid.  Please go into your account settings and change it.',
    'MODULE_PAYMENT_PAYPALR_TEXT_NOT_WPP_ACCOUNT_ERROR' => 'We are sorry for the inconvenience. The payment could not be initiated because the PayPal account configured by the store owner is not a PayPal Website Payments Pro account or PayPal gateway services have not been purchased.  Please select an alternate method of payment for your order.',
    'MODULE_PAYMENT_PAYPALR_TEXT_SANDBOX_VS_LIVE_ERROR' => 'We are sorry for the inconvenience. The PayPal account authentication settings are not yet set up or the API security information is incorrect. We are unable to complete your transaction. Please notify the store owner so they can correct this problem.',
    'MODULE_PAYMENT_PAYPALR_TEXT_WPP_BAD_COUNTRY_ERROR' => 'We are sorry -- the PayPal account configured by the store administrator is based in a country that is not supported for Website Payments Pro at the present time. Please choose another payment method to complete your order.',

    'MODULE_PAYMENT_PAYPALR_TEXT_NOT_CONFIGURED' => '<span class="alert">&nbsp;(NOTE: Module is not configured yet)</span>',
    'MODULE_PAYMENT_PAYPALR_TEXT_GETDETAILS_ERROR' => 'There was a problem retrieving transaction details. ',
    ...
    'MODULE_PAYMENT_PAYPALR_ENTRY_FIRST_NAME' => 'First Name:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_LAST_NAME' => 'Last Name:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_BUSINESS_NAME' => 'Business Name:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_NAME' => 'Address Name:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_STREET' => 'Address Street:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_CITY' => 'Address City:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_STATE' => 'Address State:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_ZIP' => 'Address Zip:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_COUNTRY' => 'Address Country:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_EMAIL_ADDRESS' => 'Payer Email:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_EBAY_ID' => 'Ebay ID:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PAYER_ID' => 'Payer ID:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PAYER_STATUS' => 'Payer Status:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_ADDRESS_STATUS' => 'Address Status:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PAYMENT_TYPE' => 'Payment Type:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PAYMENT_STATUS' => 'Payment Status:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PENDING_REASON' => 'Pending Reason:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_INVOICE' => 'Invoice:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PAYMENT_DATE' => 'Payment Date:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CURRENCY' => 'Currency:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_GROSS_AMOUNT' => 'Gross Amount:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PAYMENT_FEE' => 'Payment Fee:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_EXCHANGE_RATE' => 'Exchange Rate:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CART_ITEMS' => 'Cart items:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_TXN_TYPE' => 'Trans. Type:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_TXN_ID' => 'Trans. ID:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PARENT_TXN_ID' => 'Parent Trans. ID:',

    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_TITLE' => '<strong>Order Refunds</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_FULL' => 'If you wish to refund this order in its entirety, click here:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_BUTTON_TEXT_FULL' => 'Do Full Refund',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_BUTTON_TEXT_PARTIAL' => 'Do Partial Refund',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_TEXT_FULL_OR' => '<br>... or enter the partial ',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_PAYFLOW_TEXT' => 'Enter the ',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_PARTIAL_TEXT' => 'refund amount here and click on Partial Refund',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_SUFFIX' => '*A Full refund may not be issued after a Partial refund has been applied.<br>*Multiple Partial refunds are permitted up to the remaining unrefunded balance.',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_TEXT_COMMENTS' => '<strong>Note to display to customer:</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_REFUND_DEFAULT_MESSAGE' => 'Refunded by store administrator.',
    'MODULE_PAYMENT_PAYPALR_TEXT_REFUND_FULL_CONFIRM_CHECK' => 'Confirm: ',

    'MODULE_PAYMENT_PAYPALR_ENTRY_COMMENTS' => 'System Comments: ',
    'MODULE_PAYMENT_PAYPALR_ENTRY_PROTECTIONELIG' => 'Protection Eligibility:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AUTH_TITLE' => '<strong>Order Authorizations</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AUTH_PARTIAL_TEXT' => 'If you wish to authorize part of this order, enter the amount  here:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AUTH_BUTTON_TEXT_PARTIAL' => 'Do Authorization',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AUTH_SUFFIX' => '',

    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_TITLE' => '<strong>Capturing Authorizations</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_FULL' => 'If you wish to capture all or part of the outstanding authorized amounts for this order, enter the Capture Amount and select whether this is the final capture for this order.  Check the confirm box before submitting your Capture request.<br>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_BUTTON_TEXT_FULL' => 'Do Capture',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_AMOUNT_TEXT' => 'Amount to Capture:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_FINAL_TEXT' => 'Is this the final capture?',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_SUFFIX' => '',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_TEXT_COMMENTS' => '<strong>Note to display to customer:</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CAPTURE_DEFAULT_MESSAGE' => 'Thank you for your order.',
    'MODULE_PAYMENT_PAYPALR_TEXT_CAPTURE_FULL_CONFIRM_CHECK' => 'Confirm: ',

    'MODULE_PAYMENT_PAYPALR_ENTRY_VOID_TITLE' => '<strong>Voiding Order Authorizations</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_VOID' => 'If you wish to void an authorization, enter the authorization ID here, and confirm:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_VOID_TEXT_COMMENTS' => '<strong>Note to display to customer:</strong>',
    'MODULE_PAYMENT_PAYPALR_ENTRY_VOID_DEFAULT_MESSAGE' => 'Thank you for your patronage. Please come again.',
    'MODULE_PAYMENT_PAYPALR_ENTRY_VOID_BUTTON_TEXT_FULL' => 'Do Void',
    'MODULE_PAYMENT_PAYPALR_ENTRY_VOID_SUFFIX' => '',
    'MODULE_PAYMENT_PAYPALR_ENTRY_TRANSSTATE' => 'Trans. State:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AUTHCODE' => 'Auth. Code:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AVSADDR' => 'AVS Address match:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_AVSZIP' => 'AVS ZIP match:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_CVV2MATCH' => 'CVV2 match:',
    'MODULE_PAYMENT_PAYPALR_ENTRY_DAYSTOSETTLE' => 'Days to Settle:',

    'EMAIL_EC_ACCOUNT_INFORMATION' => 'Your account login details, which you can use to review your purchase, are as follows:',
    'MODULES_PAYMENT_PAYPALR_LINEITEM_TEXT_ONETIME_CHARGES_PREFIX' => 'One-Time Charges related to ',
    'MODULES_PAYMENT_PAYPALR_LINEITEM_TEXT_SURCHARGES_SHORT' => 'Surcharges',
    'MODULES_PAYMENT_PAYPALR_LINEITEM_TEXT_SURCHARGES_LONG' => 'Handling charges and other applicable fees',
    'MODULES_PAYMENT_PAYPALR_LINEITEM_TEXT_DISCOUNTS_SHORT' => 'Discounts',
    'MODULES_PAYMENT_PAYPALR_LINEITEM_TEXT_DISCOUNTS_LONG' => 'Credits applied, including discount coupons, gift certificates, etc',
