...
if (defined('MODULE_PAYMENT_PAYPALAC_GOOGLEPAY_TEXT_TITLE')) {
    return;
}
...
$languageFiles = [];
if (!function_exists('paypalacGooglePayGetTemplateOverrideDirectory')) {
    function paypalacGooglePayGetTemplateOverrideDirectory()
    {
...
$templateDirectory = paypalacGooglePayGetTemplateOverrideDirectory();
if ($templateDirectory !== null) {
    $languageFiles[] = $languageDirectory . $templateDirectory . '/lang.paypalac_googlepay.php';
}
$languageFiles[] = $languageDirectory . 'lang.paypalac_googlepay.php';
