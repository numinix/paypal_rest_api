<?php
/**
 * Language definitions for the paypalr_savedcard (PayPal Saved Card) payment module.
 *
 * Last updated: v1.3.3
 */
$define = [
    'MODULE_PAYMENT_PAYPALR_SAVEDCARD_TEXT_TITLE' => '%s ending in %s',
    'MODULE_PAYMENT_PAYPALR_SAVEDCARD_TEXT_TITLE_SHORT' => 'Pay with Saved Card',
    'MODULE_PAYMENT_PAYPALR_SAVEDCARD_TEXT_TITLE_ADMIN' => 'Saved Cards via PayPal Advanced Checkout',
    ...
    'MODULE_PAYMENT_PAYPALR_SAVEDCARD_TEXT_SELECT_PROMPT' => 'Please select...',
];
