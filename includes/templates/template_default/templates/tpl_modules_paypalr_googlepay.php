...
<?php if ($useNativeGooglePay): ?>
    <?php
        ...
        if (!defined('MODULE_PAYMENT_PAYPALR_GOOGLEPAY_NATIVE_CART_JS_LOADED')) {
            define('MODULE_PAYMENT_PAYPALR_GOOGLEPAY_NATIVE_CART_JS_LOADED', true);
...
<?php else: ?>
    <?php
        ...
        //
        // Use cart-specific constant to avoid conflicts with checkout
        if (!defined('MODULE_PAYMENT_PAYPALR_GOOGLEPAY_CART_JS_LOADED')) {
            define('MODULE_PAYMENT_PAYPALR_GOOGLEPAY_CART_JS_LOADED', true);
