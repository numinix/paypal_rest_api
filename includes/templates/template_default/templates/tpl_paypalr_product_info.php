...
if (
    ...
    if (!file_exists($template_path)) {
        $template_path = DIR_WS_TEMPLATES . 'template_default/templates/tpl_modules_paypalr_product_applepay.php';
    }
    include($template_path);
}
...
if (
    defined('MODULE_PAYMENT_PAYPALR_VENMO_STATUS') &&
    MODULE_PAYMENT_PAYPALR_VENMO_STATUS === 'True' &&
    defined('MODULE_PAYMENT_PAYPALR_VENMO_PRODUCT_PAGE') &&
    MODULE_PAYMENT_PAYPALR_VENMO_PRODUCT_PAGE === 'True'
) {
    $template_path = DIR_WS_TEMPLATES . $template_dir . '/templates/tpl_modules_paypalr_product_venmo.php';
    if (!file_exists($template_path)) {
        $template_path = DIR_WS_TEMPLATES . 'template_default/templates/tpl_modules_paypalr_product_venmo.php';
    }
    include($template_path);
}
?>
